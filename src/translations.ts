    ...
    capabilities: {
      ...
      services: {
        remote: {
          ...
          tag: "Conexão Segura",
          description: "Assistência segura e imediata via ferramentas remotas certificadas (TeamViewer ou AnyDesk) em qualquer lugar do mundo. Ideal para otimização, diagnósticos e instalações de software.",
          points: [
            "Sessões visuais criptografadas",
            "Sem tempos de espera de viagem",
        ...
        sos: {
          ...
          description: "Recuperação de software de alta prioridade para falhas urgentes do sistema, falhas de inicialização ou falhas de segurança no coração da Zona Sul do Rio.",
          points: [
            "Agendamento de emergência prioritário",
            "Contenção e remoção de malware",
            "Restauração crítica do sistema",
            "Verificação de diagnóstico imediata",
          ],
        },
        home: {
          ...
          description: "Reparo conveniente de software no local, configuração de rede e limpeza de computador. Perfeito para revisões detalhadas do sistema no conforto da sua casa ou escritório.",
          points: [
        ...
        multilingual: {
          ...
          subtitle: "Suporte 100% em Português",
          ...
          points: [
            ...
            "Documentação e relatórios em Português",
            "Explicações claras e acessíveis",
            "Experiência de serviço de alta qualidade",
          ],
        },
        estimate: {
          ...
          tag: "Preço Justo",
          description: "Diagnósticos completos e transparentes antes do início de qualquer reparo. Absolutamente zero taxas surpresa, pré-compromissos ou anexos técnicos complicados.",
          points: [
            "Clareza de cotação 100% adiantada",
            "Zero obrigação de realizar o trabalho",
            "Divisão clara do caminho da solução",
            "Revisão personalizada do cliente",
          ],
        },
      },
    },
